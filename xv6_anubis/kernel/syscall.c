...
extern int sys_chnice(void);
extern int sys_getstatus(void);
extern int sys_totalTickets(void);
...
static int (*syscalls[])(void) = {
    ...
    [SYS_prng] sys_prng,   [SYS_chnice] sys_chnice, [SYS_getstatus] sys_getstatus,
    [SYS_totalTickets] sys_totalTickets,
};
